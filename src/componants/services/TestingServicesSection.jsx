...
const services = [
  {
    ...
    desc: "Comprehensive manual testing to ensure functionality, usability, and quality.",
    points: ["Test Case Creation", "Functional Testing", "UI & UX Validation"],
  },
  {
    icon: FaCogs,
    title: "Automation Testing",
    desc: "Automated test solutions to improve accuracy and reduce time-to-market.",
    points: ["Selenium & Cypress", "Regression Testing", "CI/CD Integration"],
  },
  {
    icon: FaMobileAlt,
    title: "Mobile App Testing",
    desc: "End-to-end testing across multiple devices and operating systems.",
    points: ["iOS & Android Testing", "Device Compatibility", "Performance Validation"],
  },
  {
    icon: FaRocket,
    title: "Performance Testing",
    desc: "Ensure applications perform reliably under real-world load conditions.",
    points: ["Load Testing", "Stress Testing", "Scalability Analysis"],
  },
  {
    icon: FaShieldAlt,
    title: "Security Testing",
    desc: "Identify vulnerabilities and secure your applications against threats.",
    points: ["Vulnerability Assessment", "Penetration Testing", "Data Protection"],
  },
  {
    icon: FaCheckCircle,
    title: "Quality Assurance",
    desc: "End-to-end QA processes to deliver bug-free and reliable software.",
    points: ["QA Strategy", "Process Optimization", "Continuous Improvement"],
  },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            We ensure your applications are stable, secure, and performance-ready
            through comprehensive testing and quality assurance services.
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-3xl font-bold mb-6 text-gray-100">
            Ensure Quality Before You Launch
          </h3>

          <p className="text-gray-400 mb-10">
            Let our testing experts help you release reliable, secure, and
            high-performing software with confidence.
          </p>
